...

{
	...
	theme.name = "monoNight";								// Change this when making theme
	theme.displayName = "mono Night Vision";				// Change this when making theme
	theme.background = TFT_BLACK;
	theme.foreground = TFT_RED;
	...
	theme.battery_25_fgcolor  = TFT_RED;
	theme.battery_50_fgcolor  = TFT_RED;
	theme.battery_75_fgcolor  = TFT_RED;
	theme.battery_100_fgcolor = TFT_RED;
	
	theme.lcd_brightness_default = 0x6;
	theme.btn_brightness_default = 0xF;	
